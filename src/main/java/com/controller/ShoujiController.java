    ...
    */
    ...
    public R save(@RequestBody ShoujiEntity shouji, HttpServletRequest request){
        ...
        Wrapper<ShoujiEntity> queryWrapper = new EntityWrapper<ShoujiEntity>()
            ...
            .eq("xinpin_types", shouji.getXinpinTypes())
            .eq("tejia_types", shouji.getTejiaTypes())
...
//                            shoujiEntity.setShoujiTypes(Integer.valueOf(data.get(0)));   //手机类型 要改的
//                            shoujiEntity.setXinpinTypes(Integer.valueOf(data.get(0)));   //是否新品 要改的
//                            shoujiEntity.setTejiaTypes(Integer.valueOf(data.get(0)));   //是否特价 要改的
...
//                            shoujiEntity.setShoujiNewMoney(data.get(0));                    //现价 要改的
