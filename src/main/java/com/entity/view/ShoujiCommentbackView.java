...
public class ShoujiCommentbackView extends ShoujiCommentbackEntity implements Serializable {
	...
	public ShoujiCommentbackView() {

	}

	public ShoujiCommentbackView(ShoujiCommentbackEntity shoujiCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, shoujiCommentbackEntity);
