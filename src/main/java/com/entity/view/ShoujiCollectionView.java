...
public class ShoujiCollectionView extends ShoujiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String shoujiCollectionValue;
	...
	public ShoujiCollectionView() {

	}

	public ShoujiCollectionView(ShoujiCollectionEntity shoujiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, shoujiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getShoujiCollectionValue() {
				return shoujiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setShoujiCollectionValue(String shoujiCollectionValue) {
				this.shoujiCollectionValue = shoujiCollectionValue;
			}
				...
				//级联表的get和set shouji
					...
					* 获取： 是否新品
					*/
					public Integer getXinpinTypes() {
						return xinpinTypes;
					}
					/**
					* 设置： 是否新品
					*/
					public void setXinpinTypes(Integer xinpinTypes) {
						this.xinpinTypes = xinpinTypes;
					}
